...
public class ConsultationDetailCarteIT {
	...
	@Test
	public void testConsultationDetailCarte() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		assertFalse(selenium.isTextPresent("Pas d'opérations non-carte ce mois"));
		...
		selenium.waitForPageToLoad("30000");
		assertFalse(selenium.isTextPresent("Pas d'opérations non-carte ce mois"));
		selenium.click("link=Revenir au détail du compte");
		selenium.waitForPageToLoad("30000");
		selenium.click("css=button.btn");
		selenium.waitForPageToLoad("30000");
